...
# 2. ИСХОДНЫЕ ДАННЫЕ (РАЗНООБРАЗНЫЕ)
...
if C2_BLACKLIST_API_KEY != "КЛЮЧ НЕ НАЙДЕН":
    C2_SERVERS = ["185.130.5.253", "94.23.15.12", "193.42.4.1", 
                  ...
                  "45.155.205.233", "103.25.14.78"]  # расширенный список
...
# РАЗНООБРАЗНЫЕ ФАКТОРЫ РИСКА (не только 0 и 1, но и разные значения)
...
# 6. ОТПРАВКА МЕТРИК (если есть токен)
